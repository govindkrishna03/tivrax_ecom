        ...
        {displayProducts.slice(0, isExpanded ? displayProducts.length : 2).map((product, index) => (
          <div key={index} className="flex gap-3">
            <div className="w-16 h-16 flex-shrink-0 bg-gray-100 rounded-md overflow-hidden">
              <img 
                src={product.img || "/default-product-image.jpg"} 
                alt={product.name} 
      ...
      <div className="pt-4 border-t border-gray-200">
        ...
        {/* {totalPrice < 999 && (
          <p className="text-xs text-green-600 mt-2">
            Add items worth ₹{(999 - totalPrice).toFixed(2)} more for free shipping!
          </p>
        )} */}
      </div>
      
      {/* <div className="mt-6 text-xs text-gray-500">
        <p>Free returns within 30 days for most items.</p>
