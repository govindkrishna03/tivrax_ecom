...
const paymentMethods = [
  ...
  },
  {
    ...
    icon: "🖼️" // You can replace with any QR code representation emoji or icon
  }
];
      ...
      >
        ...
        {selectedMethod === "qr" && qrCodeUrl && (
          <div className="mt-6 text-center">
            <h3 className="font-medium text-gray-900">Scan the QR Code to Pay:</h3>
            <img src={qrCodeUrl} alt="QR Code" className="mx-auto mt-4 w-40 h-40" />
            <motion.button
              whileTap={{ scale: 0.97 }}
